...
ImVec2 PanelLayout::footerButtonMin(int f, int footer_rows,
...
ImVec2 PanelLayout::footerButtonMax(int f, int footer_rows,
                                    int list_count) const {
...
PanelLayout PanelBase::beginPanel(const char *title, int list_count,
...
void PanelBase::drawFooterButton(int id, const char *label,
                                 const PanelLayout &L, int button_index,
                                 int total_buttons, int list_count,
                                 bool focused, bool hovered) {
